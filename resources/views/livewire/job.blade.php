<div>
    <div class="px-3 py-5 mb-3 shadow-sm hover:shadow-md duration-200 rounded border-2 border-gray-300">
        <div class="flex justify-between">
            ...
            <button class="w-5 h-5 text-gray-500 focus:outline-none" wire:click="addLike">
                <svg  xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="{{$job->isLiked() ? 'green':'white'}}" viewBox="0 0 24 24" stroke="green">
